...
const TiltCard = ({ date, status, text, children, gradient }) => {
  ...
  return (
    <motion.div
      ...
      className="relative border border-n-6 h-[66vh] lg:h-[70vh] xl:h-[74vh] rounded-2xl group"
    >
      ...
      <div
        ...
        className="absolute inset-4 sm:inset-6 co place-content-center p-5 md:p-7 lg:p-7 xl:p-10 rounded-2xl"
      >
