...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[57.25rem] left-20 right-20 h-0.25 bg-n-6 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[56.9375rem] left-[4.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[56.9375rem] right-[4.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
